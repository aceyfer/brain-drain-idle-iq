...
namespace BrainDrain.Systems
{
    ...
    /// Power/Cash/IQ deltas. Added 2026-06-21 for the Illumisnotty interference events.
    ...
    public sealed class BrainRotEventData : ScriptableObject
    {
        ...
        [Tooltip("Instant Cash reward/penalty, mirroring brainPowerRewardOrPenalty -- added 2026-06-21 for events like Illumisnotty Leak. 0 for the original 8 events, which never touched Cash.")]
        ...
        [Header("Timed Effect (Illumisnotty interference events, added 2026-06-21)")]
