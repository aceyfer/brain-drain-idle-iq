...
{
    /// <summary>
    /// Handles the Illumisnotty faction visuals: the HUD Badge in the top-left (membership card),
    /// and the Interference visual effect (red vignette flash + watermark) on negative random events.
    /// </summary>
    public sealed class IllumisnottyManagerUI : MonoBehaviour
    {
        [Header("Assets")]
        [SerializeField] private Sprite roundedRectSprite;
        [SerializeField] private Sprite vignetteSprite;
        [SerializeField] private TMP_FontAsset fontAsset;
        [Tooltip("Phase 2 HUD owns the Illumisnotty title. Leave this off to avoid a duplicate runtime RANK badge.")]
        ...
        private void CreateHUDBadge()
        {
            ...
            // 1. Create Badge base
            badgeGo = new GameObject("Illumisnotty_HUD_Badge", typeof(RectTransform));
        ...
        private void CreateInterferenceUI()
        {
            ...
            var vigGo = new GameObject("Illumisnotty_Interference_Vignette", typeof(RectTransform));
            ...
            var textGo = new GameObject("Illumisnotty_Watermark_Text", typeof(RectTransform));
        ...
        private void UpdateBadgeText(int rebirthCount)
        {
            if (badgeText != null)
            {
                badgeText.text = "RANK: " + RebirthManager.GetIllumisnottyTitle(rebirthCount);
            }
        }
