...
**Status: pending Aceyfer Play-mode verification.** Checklist: fresh-save FTUE copy unchanged; POCKET button sits below Dia-Log; empty state → collect a card → reopen shows the spine → tap re-reads the full card → survives save/reload.
